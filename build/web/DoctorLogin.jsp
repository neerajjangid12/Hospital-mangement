...
<html>
    <head>
        ...
        <link rel="stylesheet" href="components/DoctorLoginBack.css">
    </head>
    <body class="">
        <%@ include file="components/Navbar.jsp" %>
        <script src="https://cdn.jsdelivr.net/gh/alpinejs/alpine@v2.x.x/dist/alpine.js" defer></script>

        <div class="container max-w-full mx-auto py-40 px-6 back-image bg-blue-100">
            <div class="font-sans">
                        ...
                        <div class="w-full relative">
                            <div class="mt-6">
                                <div class="text-center font-semibold text-black">
                                    <h1 class="text-3xl font-semibold">Doctor Login</h1>
                                ...
                                <form class="mt-8" action="DoctorLogin" method="post">
                                        ...
                                        <div class="flex justify-between"><label class="block text-gray-500 font-bold my-4"><input type="checkbox"
                                                    ...
                                                    class="cursor-pointer tracking-tighter text-black border-b-2 border-gray-200 hover:border-gray-400"><span>Forgot
                                                        ...
                                                        bg-gray-800 w-full text-white rounded-lg
                                                                                                   px-6 py-3 block shadow-xl hover:text-white bg-black" type="submit">
                                            Login
                                        </button>
                                    </div>
                                </form>
