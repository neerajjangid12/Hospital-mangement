...
<div class="bg-green-500 h-12 flex items-center">
        ...
        <div class="space-x-8 flex flex-row items-center">
            ...
            <div class="space-x-3">
                <a href="index.jsp" class="text-amber-50 text-lg">HOME</a> <a
                    href="Doctor.jsp" class="text-amber-50 text-lg">DOCTOR</a> <a
                    href="Appointment.jsp" class="text-amber-50 text-lg">PATIENT</a>
            </div>
        </div>
        <div>
            <button class="bg-white text-black px-3 py-2 font-bold  rounded-md peer focus:bg-gray-400 focus:text-gray-200 transition-all duration-200  ">Admin</button>
            <div class=' w-48 absolute top-5 z-10
                 ...
                 '><ul class='py-6 px-9 flex flex-col '>
                    <li><a class='cursor-pointer bg-sky-300 p-3 rounded-md hover:opacity-90 text-white' href="../Adminlogout">Logout</a></li>
                </ul>
            </div>
        </div>
    </div>
