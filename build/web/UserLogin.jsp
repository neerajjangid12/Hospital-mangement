...
<html>
    ...
    <body class="bg-gradient-to-r from-cyan-200 to-blue-500">
        ...
        <div class="container max-w-full mx-auto px-6 ">
            <img src="./img/userlogo.png" class="pt-10 pl-20 inline-block">
            <div class="font-sans">
                <div class="max-w-sm mx-auto px-6">
                    <div class="relative flex flex-wrap">
                        <div class="w-full relative">
                            <div class="">
                                ...
                                <form class="mt-5" action="UserLogin" method="post">
                                    <div class="mx-auto max-w-lg">
                                        <div class="py-2">
                                            <span class="px-1 text-sm text-gray-600">Email</span> <input
                                        ...
                                        <div class="flex justify-between">
                                            <label class="block text-gray-500 font-bold my-4"><input
                                                    type="checkbox" class="leading-loose text-pink-600">
                                                <span class="py-2 text-sm text-gray-600 leading-snug">
                                                    Remember Me </span></label> <label
                    ...
                    <h4 class="pt-3">Don't have an account? <a href="signup.jsp" class="text-blue-500">create one</a></h4>
                </div>
